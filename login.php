...
<head>
    ...
    <title>Login Aplikasi Kasir | by.rivaldoantonio</title>
...
<body class="text-center">
    ...
    <form class="form-signin" method="POST">
      <img class="mb-4" src="assets/images/logo-rivaldo.png" alt="" width="72" height="72">
      ...
      <p class="mt-3 mb-3 text-white">&copy;By - <a target="_blank" rel="noopener noreferrer" href="https://wa.me/088271491374" class="text-white">
     Rivaldo Antonio Arnold</a></p>
    </form>
