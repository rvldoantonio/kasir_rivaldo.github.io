    ...
    <div class="row">
        <div class="col-12 py-3 my-3 border-top border-bottom">
            <div class="row">
                ...
                <div class="col-2"><h2 class="mb-0 py-1" style="font-weight:700;">Jumlah</h2></div>
        ...
        <div class="col-12">
            <div class="row">
                ...
                <div class="col-2"><h2 class="mb-0 py-1" style="font-weight:500;"><?php echo ribuan($c['jumlah']); ?></h2></div>
      ...
      <div class="col-12 py-3 my-3 border-top">
        ...
        <div class="col-12 text-center mt-5">
            <h2>* Terima Kasih Telah Berbelanja Di Toko Rivaldo *</h2>
        </div>
    </div><!-- end row -->
</div><!-- end box print -->
</section>
